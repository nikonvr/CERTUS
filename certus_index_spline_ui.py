...
from certus_data import build_export_context, build_report_sections, export_optimization_report, read_data_file_robust
...
class _ExcelExportMixin:
    ...
    def export_excel(self, auto_export: bool = False) -> None:
        ...
        from certus_data import validate_manifest_for_export
