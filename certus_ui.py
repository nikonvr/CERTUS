...
# OPENPYXL_AVAILABLE imported from certus_core (Single Source of Truth)


from certus_core import OPENPYXL_AVAILABLE
    ...
    def update_appearance(self) -> None:
        ...
        self.setStyleSheet(f"""
            ...
            QPushButton {{
                ...
                background: {CertusTheme.SURFACE}; border: 1px solid {CertusTheme.BORDER};

                border-radius: 16px; font-size: 14px;

            }}

            QPushButton:hover {{ border-color: {CertusTheme.PRIMARY}; }}
...
class CertusBaseApp(QMainWindow):
    ...
    def export_premium_excel(self, sections, output_path: str | None = None, *, ctx=None) -> str | None:
        ...
        """
        try:
            from certus_reports import build_excel_report
        except ImportError:
    ...
    def export_premium_pdf(self, sections, output_path: str | None = None, *, ctx=None) -> str | None:
        ...
        """
        try:
            from certus_reports import build_pdf_report
        except ImportError:
    ...
    def _auto_install_empty_states(self) -> None:
        ...
        """
        try:
            from certus_empty_state import attach_empty_state_to
        except ImportError:
            return
    ...
    def _setup_logger(self, name: str) -> Any:
        ...
        from certus_core import setup_gui_logger
    ...
    def _apply_certus_compact_theme(self, plots: list) -> None:
        ...
        apply_certus_theme(
            ...
            overrides=f"""
                ...
                QLabel#HeaderLabel {{ font-size: 14px; font-weight: bold; }}
                QPushButton {{ font-size: 11px; padding: 4px; }}
                QComboBox {{ font-size: 11px; padding: 2px; }}
                QDoubleSpinBox, QSpinBox {{ font-size: 11px; padding: 2px; }}
            """,
        )
