...
class TestStratSymmetryContractAndStability:
    ...
    def test_run_final_simulation_block_prefers_sym_on_true_tie(self, monkeypatch):
        ...
        monkeypatch.setattr("certus.core.certus_strat_solvers._test_strategy_robustness_task", fake_test)


        monkeypatch.setattr("certus.core.certus_strat_solvers._calculate_strategy_spectral_resolution", lambda *_a, **_k: (1.0, 1))


        monkeypatch.setattr("certus.core.certus_strat_solvers.get_refractive_clues_vectorized", lambda *_a, **_k: np.ones(3, dtype=np.complex128))


        monkeypatch.setattr(
            "certus.core.certus_strat_solvers.calculate_RT_vectorized_real_HL",
        ...
        monkeypatch.setattr("certus.core.certus_strat_solvers.get_safe_worker_count", lambda: 1)
    ...
    def test_run_final_simulation_block_tie_is_deterministic_by_strategy_id(self, monkeypatch):
        ...
        monkeypatch.setattr("certus.core.certus_strat_solvers.get_safe_worker_count", lambda: 2)
    ...
    def test_run_final_simulation_block_consensus_reranks_seed_sensitive_top1(self, monkeypatch):
        ...
        monkeypatch.setattr("certus.core.certus_strat_solvers._test_strategy_robustness_task", fake_task)
