...
def test_analytical_quarter_wave():
    ...
    # calculate_RT_single_layer_single (includes backside, so compare T_total and R_total)
    ...
    check("calculate_RT_single_layer_single R_total", R_sl, R_total_expected)


    check("calculate_RT_single_layer_single T_total", T_sl, T_total_expected)
