    ...
    def on_cell_clicked(self, row: int, col: int):
        ...
        if strategy_result:
            ...
            if extrema_distances or theo_profile:
                ...
                def _remove_details_dialog(*_args, dialog=dlg):
...
class WorkerThread(QThread):
    ...
    def __init__(
        ...
        self.opti_results = (
            dict(self.request.opti_results) if isinstance(self.request.opti_results, dict) else self.request.opti_results
        )
    ...
    def _run_step_2(self):
        ...
        self.signals.finished.emit(
            WorkerThreadResult.for_step_2(opti_results=opti_results).to_legacy_dict()
        )
    ...
    def _run_step_3(self):
        ...
        self.signals.finished.emit(
            WorkerThreadResult.for_step_3(final_results=final_results).to_legacy_dict()
        )
    ...
    def _run_step_23_full(self):
        ...
        try:
            ...
            with SharedIndicesManager(
                ...
                self.signals.finished.emit(
                    WorkerThreadResult.for_step_23(
