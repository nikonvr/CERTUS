...
def test_symmetric_ns1():
    ...
    R_sl, T_sl = calculate_transmission_single(wl, 2.35, 0.05, d, complex(1.0))
...
def test_index_cost_gradient():
    ...
    def compute_cost(d_val, n_arr_val, k_arr_val):
        ...
        for i in range(n_wls):
            ...
            R_i, T_i = calculate_transmission_single(


                wls[i], n_arr_val[i], k_arr_val[i], d_val, complex(n_sub[i])
