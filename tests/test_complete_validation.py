...
def test_json_parsing():
    ...
    examples = [
        "example/JSON-design-example.json",
        "example/JSON-metal-example.json",
        "example/JSON-strat-example.json",
    ]
...
def test_csv_parsing():
    ...
    csv_files = ["example/CSV-index-example.csv", "example/CSV-metal-example.csv"]
