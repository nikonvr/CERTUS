...
class CertusResetManager:
    ...
    def _stop_all_workers(self) -> None:
        ...
        workers = [
            'optim_worker', 'eval_worker', 'col_worker',
            'needle_worker', 'warmup_worker', 'worker',
            'beam_worker', 'optimization_thread', 'beam_thread',
            '_worker', '_worker2', '_beam_worker',
            '_thread', '_thread2', '_beam_thread',  # INDEX QThreads
        ]
    ...
    def _clear_ui_elements(self) -> None:
        ...
        table_names = [
            'front_table', 'back_table', 'target_table',
            'results_table', 'strategies_table', 'table',
        ]
    ...
    def _reset_all_plots(self) -> None:
        ...
        plot_names = [
            'spectrum_plot', 'profile_plot', 'nk_plot',
            'color_plot', 'reflectance_plot', 'plot_spectrum',
            'plot_convergence', 'plot_nk',
        ]
    ...
    def _clear_internal_state(self) -> None:
        ...
        data_structures = [
            'pareto_history', 'latest_results', 'target_data',
            'beam_stats', 'undo_stack', 'accumulated_evals'
        ]
        ...
        # Clear plot caches
        cache_names = [
            '_live_curves', '_live_curve', '_live_points',
            '_oblique_spectrum_colors', 'curve_points'
        ]
