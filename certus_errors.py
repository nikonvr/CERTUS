...
def validate_wavelength_range(
    ...
    lambda_min: float, lambda_max: float, context: str = "spectral range"
...
def show_error(parent, error_code: str, **kwargs):
...
def show_validation_error(parent, error: CertusValidationError):
